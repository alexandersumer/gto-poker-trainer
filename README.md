...
- **Rival modelling** – `dynamic.rival_strategy` builds strength-aware response profiles. Rivals weight their fold/continue decisions by combo quality (with calibrated noise) instead of reading hero’s exact hand, producing more resilient, solver-like counterplay.
