...
def _villain_profile(
    ...
    *,
    ...
    try:
        ...
        # If anything goes wrong we silently drop the profile and fall back to
        # deterministic behaviour. This keeps training resilient to malformed
        # metadata.
        return None
        ...
        options.append(
            Option(
                ...
                meta={
                    ...
                    **({"villain_profile": profile} if profile else {}),
                },
            )
        )
