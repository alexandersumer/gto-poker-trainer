...
.PHONY: ensure-python
	...
	@$(UV_RUN) python -c "import sys; version = sys.version.split()[0]; expected = '3.13.7'; assert version == expected, f'Expected {expected}, got {version}'; print(f'Using Python {version}')"
